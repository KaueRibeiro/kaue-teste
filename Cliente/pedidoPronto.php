...
$id = $_GET['idEvent'];
		...
		if(isset($_POST['busca']) != '') {
	    ...
	    }else 
		 {
			...
			$sql = mysql_query("select * from pedido where status = 'Pronto' and id_evento = $id");
			}
?>
...
<center>
		<table class="table" style="max-width: 800px">
			...
			<th align="center"> <a href="acaopedido.php?pedido=<?php echo $linha['id_pedido'] ?>&acao=entregue">Entregue</th>
	       <tr>
			</Tbody>
</center>		 
			<?php  }
			  ...
			  echo "<center>";
			  echo "<hr>";
		      echo "<a href=\"menuCliente.php\">Fechar Cozinha </a>";?> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo "<a href=\"listagemPedido.php?idEvent=$id\">Pedidos Aguardando Atendimento </a>";  
			  echo "<hr>";
			}  ?>
